...
- React Native WebView upstream reference: `window.ReactNativeWebView.postMessage` is injected when `onMessage` is set, and `data` must be a string ([react-native-webview/docs/Reference.md](https://github.com/react-native-webview/react-native-webview/blob/d65a961080dad3e82d33370ad6e8d90e973fcbd3/docs/Reference.md)).
