...
- MDN `DataTransferItem.getAsFileSystemHandle()`: returns a file or directory handle for a dragged item; the limited-availability API should be feature-detected and paired with a fallback. <https://developer.mozilla.org/en-US/docs/Web/API/DataTransferItem/getAsFileSystemHandle>
